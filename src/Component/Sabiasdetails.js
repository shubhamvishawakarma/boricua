...
const Sabiasdetails = () => {
  ...
  const singlelistingg = () => {
    ...
    let sabiasidd = secureLocalStorage.getItem("sabias");
    ...
    axios
      .post(`${apiurl[0].apiUrl}React/sabias_ret_details`, data, options)
      .then((res) => {
  ...
  const eventImages = singlelisting?.image;

  let a = secureLocalStorage.getItem("_id");
  console.log("sad", a);
  return (
    <div>
      {/* ============================================================== */}
                  ...
                  <div className="Goodup-lkp-flex d-flex align-items-start justify-content-start">
                    ...
                    <div className="Goodup-lkp-caption ps-3">
                      <div className="Goodup-lkp-title">
                        <h1 className="mb-0 ft-bold">{singlelisting?.title}</h1>
                      </div>
                          ...
                          <div className="" key={index}>
                            <a href="#" className="">
                              <img
                                width={"100%"}
                                height={"210px"}
                                src={`https://logicaltest.website/Anju/Boricua/assets/bori_images/event/${items?.images}`}
                                className=""
                                alt=""
                              />
                            </a>
                ...
                <div className="d-block">
                  <div className="jbd-01">
                    <div className="jbd-details">
                      <h5 className="ft-bold fs-lg">About the Sabias Que</h5>
                      <div className="d-block mt-3">
                      ...
                      <li>
                        <div className="list-uiyt">
                          ...
                          <div className="list-uiyt-capt">
                            ...
                            >
                              <p>{singlelisting?.event_location}</p>
                            </a>
                          </div>
                        </div>
                      </li>
