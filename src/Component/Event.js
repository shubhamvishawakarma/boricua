                ...
                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                  <div className="m-spaced">
                    <div className="position-relative">
                      ...
                      <p className="mb-3"><i className="fa fa-arrow-right" aria-hidden="true" />Register for upcoming business events.</p>
                      <p className="mb-3"><i className="fa fa-arrow-right" aria-hidden="true" />Watch on-demand videos.</p>
                      <p className="mb-3"><i className="fa fa-arrow-right" aria-hidden="true" />Learn from business owners, industry experts, and more</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="row justify-content-center">
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <div className="sec_title position-relative text-center mb-4">
                    <h4 className="theme-cl mb-0">On-demand events</h4><br />
                  </div>
                </div>
              </div>
              <div className="row justify-content-center">
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div className="gup_blg_grid_box">
                    ...
                    <div className="gup_blg_grid_caption">
                      <div className="blg_title"><h4><a href="blog-detail.html">How to add a business to Boricua</a></h4></div>
                    </div>
