...
const Lessdetails = () => {
  ...
  const [presentodetails, setpresentodetails] = useState([]);

  let lessidd = secureLocalStorage.getItem("lessid");

  useEffect(() => {
    presentodetailss();
  }, []);

  const presentodetailss = () => {
    const options = {
      headers: {
    ...
    axios
      .post(`${apiurl[0].apiUrl}React/presento_details`, data, options)
      .then((res) => {
        setpresentodetails(res.data.data);
      })
      .catch((err) => {
        //console.error(err);
      });
  ...
  const lat = presentodetails?.present_lat;
  const lon = presentodetails?.present_long;
  const zoom = 16;
  const eventImages = presentodetails?.present_image;
                      ...
                      <div className="d-block mt-3">
                        <div className="list-lioe">
                          ...
                          <div className="list-lioe-single ms-2 ps-3 seperate">
                            ...
                            >
                              {presentodetails?.present_location}
                            </a>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="list-lioe">
                          <div className="list-lioe-single">
                            ...
                            <span className="ft-medium ms-2">
                              {presentodetails?.pre_date} -{" "}
                              {presentodetails?.pre_time}
                            </span>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="" key={index}>
                            <a href="#" className="">
                              <img
                                width={"100%"}
                                height={"210px"}
                                src={`https://logicaltest.website/Anju/Boricua/assets/bori_images/event/${items?.present_image}`}
                                className=""
                                alt=""
                              />
                            </a>
                ...
                <div className="d-block">
                  <div className="jbd-01">
                    <div className="jbd-details">
                      <h5 className="ft-bold fs-lg">About the Less Presento</h5>
                      <div className="d-block mt-3">
                        <p style={{ textAlign: "justify" }}>
                          {presentodetails?.present_description}
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <li>
                        <div className="list-uiyt">
                          ...
                          <div className="list-uiyt-capt">
                            ...
                            >
                              <p>{presentodetails?.present_location}</p>
                            </a>
                          </div>
                        </div>
                      </li>
