...
const Volunteringdetails = () => {
  ...
  const [volunteringg, setvolunteringg] = useState([]);

  let volidid = secureLocalStorage.getItem("volunteringid");
  ...
  const volunteringde = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}React/vol_details_react`, data, options)
      .then((res) => {
        setvolunteringg(res.data.data);
      })
      .catch((err) => {
        //console.error(err);
      });
  };
  const lat = volunteringg?.vol_lat;
  const lon = volunteringg?.vol_long;
  const zoom = 16;
  const eventImages = volunteringg?.vol_image;
                          ...
                          <div className="" key={index}>
                            <a href="#" className="">
                              <img
                                width={"100%"}
                                height={"210px"}
                                src={`https://logicaltest.website/Anju/Boricua/assets/bori_images/event/${items?.vol_image}`}
                                className=""
                                alt=""
                              />
                            </a>
                ...
                <div className="d-block">
                  <div className="jbd-01">
                    <div className="jbd-details">
                      <h5 className="ft-bold fs-lg">About the Voluntering</h5>
                      <div className="d-block mt-3">
                        <p style={{ textAlign: "justify" }}>
                          {volunteringg?.vol_description}
                        </p>
                      </div>
                    </div>
                  </div>
