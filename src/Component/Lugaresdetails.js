...
const Lugaresdetails = () => {
  ...
  let vacationidd = secureLocalStorage.getItem("vacationid");
  ...
  const singlelistingg = () => {
    ...
    const data = JSON.stringify({
      vacation_id: vacationidd,
    });

    axios
      .post(`${apiurl[0].apiUrl}React/vacation_ret_details`, data, options)
      .then((res) => {
  ...
  const lat = singlelisting?.latitude;
  const lon = singlelisting?.longitude;
  const zoom = 16; // 15 is ideal

  const eventImages = singlelisting?.vacation_image;
                  ...
                  <div className="Goodup-lkp-flex d-flex align-items-start justify-content-start">
                    ...
                    <div className="Goodup-lkp-caption ps-3">
                      <div className="Goodup-lkp-title">
                        <h1 className="mb-0 ft-bold">{singlelisting?.name}</h1>
                      </div>
                        ...
                        <div className="list-lioe">
                          <div className="list-lioe-single">
                            ...
                            <span className="ft-medium ms-2">
                              {singlelisting?.vacation_date} -{" "}
                              {singlelisting?.vacation_time}
                            </span>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="" key={index}>
                            <a href="#" className="">
                              <img
                                width={"100%"}
                                height={"210px"}
                                src={`https://logicaltest.website/Anju/Boricua/assets/bori_images/event/${items?.vacation_image}`}
                                className=""
                                alt=""
                              />
                            </a>
                ...
                <div className="d-block">
                  <div className="jbd-01">
                    <div className="jbd-details">
                      <h5 className="ft-bold fs-lg">About the Vacation</h5>
                      <div className="d-block mt-3">
