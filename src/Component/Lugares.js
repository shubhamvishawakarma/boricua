...
const Lugares = () => {
  ...
  const educational = () => {
    ...
    axios
      .post(`${apiurl[0].apiUrl}React/get_r_vacation`, data, options)
      .then((res) => {
        ...
        <div className="row">
          ...
          <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div className="sec_title position-relative text-center mb-5">
              <h2 className="ft-bold">Lugares Para Quedarse</h2>
            </div>
            <div className="row justify-content-left gx-3">
              {education.map((list) => {
                return (
                  <div
                    onClick={() => {
                      secureLocalStorage.setItem("vacationid", list?.id);
                    }}
                    ...
                    <div className="Goodup-featured-tag">Featured</div>
                      ...
                      <div className="Goodup-grid-fl-wrap">
                        <div className="Goodup-caption px-3 py-2">
                          ...
                          {/* <div className="Goodup-cates"><a href="/Lugaresdetails">Wedding</a></div> */}
