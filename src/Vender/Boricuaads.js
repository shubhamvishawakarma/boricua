            ...
            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
              <div className="m-spaced">
                <div className="position-relative">
                  ...
                  <h2 className="ft-bold mb-3">Get more leads with Boricua Directory Ads</h2>
                  <h6 className="mb-3">There’s no better opportunity to get 2.5x more leads for your business..</h6>
                  <h6 className="mb-3"><b>Special Offer:</b> $300 in free credit when you start Yelp Ads</h6>
                </div>
                <a href className="btn btn-danger">Starts Ads</a>
              </div>
            </div>
      ...
      <section className="space min gray">
        <div className="container">
          <div className="row">
            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
              <div className="Goodup-price-wrap">
                <div className="Goodup-author-header">
                  ...
                  <div className="Goodup-price-subtitle"><h4>Be (literally) ahead of the competition </h4></div>
            ...
            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
              <div className="Goodup-price-wrap">
                <div className="Goodup-author-header">
                  ...
                  <div className="Goodup-price-subtitle"><h4>Be in charge of your ads</h4></div>
            ...
            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
              <div className="Goodup-price-wrap">
                <div className="Goodup-author-header">
                  ...
                  <div className="Goodup-price-subtitle"><h4>Be in front of the right customers </h4></div>
            ...
            <div className="col-xl-2 col-lg-2 col-md-12 col-sm-12 col-12"><a href className="btn btn-danger">Starts Ads</a></div>
            <div className="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12" />
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div className="sec_title position-relative text-center mb-5">
                <h2 className="ft-bold">Boricua Directory Ads include</h2>
              </div>
            </div>
          </div>
          {/* row */}
          <div className="row align-items-center">
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
              <div className="cats-wrap text-center">
                <a href="listing-search-v1.html" className="Goodup-catg-wrap">
                  <div className="Goodup-catg-icon"><i className="fa fa-search" /></div>
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
              <div className="cats-wrap text-center">
                <a href="listing-search-v1.html" className="Goodup-catg-wrap">
                  <div className="Goodup-catg-icon"><i className="fas fa-comment-alt" /></div>
                  <div className="Goodup-catg-caption">
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
              <div className="cats-wrap text-center">
                <a href="listing-search-v1.html" className="Goodup-catg-wrap">
                  <div className="Goodup-catg-icon"><i className="fas fa-camera" /></div>
                  <div className="Goodup-catg-caption">
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
              <div className="cats-wrap text-center">
                <a href="listing-search-v1.html" className="Goodup-catg-wrap">
                  <div className="Goodup-catg-icon"><i className="	far fa-address-card" /></div>
                  <div className="Goodup-catg-caption">
            ...
            <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
              <div className="cats-wrap text-center">
                <a href="listing-search-v1.html" className="Goodup-catg-wrap">
                  <div className="Goodup-catg-icon"><i className="fa fa-star" /></div>
                  <div className="Goodup-catg-caption">
