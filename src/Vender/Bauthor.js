                  ...
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-1.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                        ...
                        <div className="Goodup-cates"><a href="search.html">Wedding</a></div>
                        <h4 className="mb-0 ft-medium medium"><a href="listing-search-v1.html" className="text-dark fs-md">Rajwara Marriage Home<span className="verified-badge"><i className="fas fa-check-circle" /></span></a></h4>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-2.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                        <div className="Goodup-author"><a href="author-detail.html"><img src="assets/img/t-2.png" className="img-fluid circle" alt="" /></a></div>
                        <div className="Goodup-cates"><a href="search.html">Sports</a></div>
                        <h4 className="mb-0 ft-medium medium"><a href="listing-search-v1.html" className="text-dark fs-md">Decathlon Sport House<span className="verified-badge"><i className="fas fa-check-circle" /></span></a></h4>
                        <div className="Goodup-middle-caption mt-3">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-3.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                        <div className="Goodup-author"><a href="author-detail.html"><img src="assets/img/t-3.png" className="img-fluid circle" alt="" /></a></div>
                        <div className="Goodup-cates"><a href="search.html">Hotels</a></div>
                        <h4 className="mb-0 ft-medium medium"><a href="listing-search-v1.html" className="text-dark fs-md">The Gold Hotel Lalit<span className="verified-badge"><i className="fas fa-check-circle" /></span></a></h4>
                        <div className="Goodup-middle-caption mt-3">
                          <div className="Goodup-location"><i className="fas fa-map-marker-alt" />California, USA</div>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-4.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                        <div className="Goodup-author"><a href="author-detail.html"><img src="assets/img/t-4.png" className="img-fluid circle" alt="" /></a></div>
                        <div className="Goodup-cates"><a href="search.html">Zym &amp; Health</a></div>
                        <h4 className="mb-0 ft-medium medium"><a href="listing-search-v1.html" className="text-dark fs-md">Fitness Revolution Gym<span className="verified-badge"><i className="fas fa-check-circle" /></span></a></h4>
                        <div className="Goodup-middle-caption mt-3">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-5.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                        <div className="Goodup-author"><a href="author-detail.html"><img src="assets/img/t-5.png" className="img-fluid circle" alt="" /></a></div>
                        <div className="Goodup-cates"><a href="search.html">Beauty &amp; Makeup</a></div>
                        <h4 className="mb-0 ft-medium medium"><a href="listing-search-v1.html" className="text-dark fs-md">Pretty Woman Smart Batra<span className="verified-badge"><i className="fas fa-check-circle" /></span></a></h4>
                        <div className="Goodup-middle-caption mt-3">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-6.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                        <div className="Goodup-author"><a href="author-detail.html"><img src="assets/img/t-6.png" className="img-fluid circle" alt="" /></a></div>
                        <div className="Goodup-cates"><a href="search.html">Night Party</a></div>
                        <h4 className="mb-0 ft-medium medium"><a href="listing-search-v1.html" className="text-dark fs-md">The Sartaj Blue Night<span className="verified-badge"><i className="fas fa-check-circle" /></span></a></h4>
                        <div className="Goodup-middle-caption mt-3">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-7.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                        <div className="Goodup-author"><a href="author-detail.html"><img src="assets/img/t-7.png" className="img-fluid circle" alt="" /></a></div>
                        <div className="Goodup-cates"><a href="search.html">Cafe &amp; Bar</a></div>
                        <h4 className="mb-0 ft-medium medium"><a href="listing-search-v1.html" className="text-dark fs-md">Pizza Delight Cafe<span className="verified-badge"><i className="fas fa-check-circle" /></span></a></h4>
                        <div className="Goodup-middle-caption mt-3">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-8.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                        <div className="Goodup-author"><a href="author-detail.html"><img src="assets/img/t-8.png" className="img-fluid circle" alt="" /></a></div>
                        <div className="Goodup-cates"><a href="search.html">Shopping Mall</a></div>
                        <h4 className="mb-0 ft-medium medium"><a href="listing-search-v1.html" className="text-dark fs-md">The Great Allante Shop<span className="verified-badge"><i className="fas fa-check-circle" /></span></a></h4>
                        <div className="Goodup-middle-caption mt-3">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-9.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-10.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-11.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                  <div className="Goodup-grid-wrap">
                    <div className="Goodup-grid-upper">
                      ...
                      <div className="Goodup-grid-thumb">
                        <a href="listing-search-v1.html" className="d-block text-center m-auto"><img src="assets/img/listing/l-12.jpg" className="img-fluid" alt="" /></a>
                      </div>
                    </div>
                    <div className="Goodup-grid-fl-wrap">
                      <div className="Goodup-caption px-3 py-2">
