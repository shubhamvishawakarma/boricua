        ...
        <div className="container">
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
              <div className="gup_blg_grid_box">
                <div className="gup_blg_grid_thumb">
                  <a href="/bblogdetails"><img src="assets/img/b-1.jpg" className="img-fluid" alt="" /></a>
                </div>
                <div className="gup_blg_grid_caption">
                  <div className="blg_tag"><span>Marketing</span></div>
                  <div className="blg_title"><h4><a href="/bblogdetails">What Is a VPN and How Does It Work?</a></h4></div>
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
              <div className="gup_blg_grid_box">
                <div className="gup_blg_grid_thumb">
                  <a href="/bblogdetails"><img src="assets/img/b-2.jpg" className="img-fluid" alt="" /></a>
                </div>
                <div className="gup_blg_grid_caption">
                  <div className="blg_tag"><span>Business</span></div>
                  <div className="blg_title"><h4><a href="/bblogdetails">What Is Ransomware: The Ultimate Guide?</a></h4></div>
                  <div className="blg_desc"><p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum</p></div>
                </div>
                <div className="crs_grid_foot">
                  <div className="crs_flex d-flex align-items-center justify-content-between br-top px-3 py-2">
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
              <div className="gup_blg_grid_box">
                <div className="gup_blg_grid_thumb">
                  <a href="/bblogdetails"><img src="assets/img/b-3.jpg" className="img-fluid" alt="" /></a>
                </div>
                <div className="gup_blg_grid_caption">
                  <div className="blg_tag"><span>Accounting</span></div>
                  <div className="blg_title"><h4><a href="/bblogdetails">Can iPads Get Viruses? What You Need</a></h4></div>
                  <div className="blg_desc"><p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum</p></div>
                </div>
                <div className="crs_grid_foot">
                  <div className="crs_flex d-flex align-items-center justify-content-between br-top px-3 py-2">
