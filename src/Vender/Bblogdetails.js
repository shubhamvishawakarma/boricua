                                ...
                                <div className="comment-details">
                                  <div className="comment-meta">
                                    <div className="comment-left-meta">
                                      <h4 className="author-name">Kermit C. Mitchell <span className="selected"><i className="fas fa-bookmark" /></span></h4>
                                ...
                                <li className="article_comments_wrap">
                                  <article>
                                    ...
                                    <div className="comment-details">
                                      <div className="comment-meta">
                                        <div className="comment-left-meta">
                                          <h4 className="author-name">Kermit C. Mitchell</h4>
                                          <div className="comment-date">19th May 2018</div>
                                        </div>
                                        <div className="comment-reply">
                        ...
                        <div className="comment-form">
                          <form action="#">
                            <div className="row">
                              ...
                              <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="form-group">
                                  <a href="#" className="btn theme-bg text-white">Submit Now</a>
                                </div>
                              </div>
                            </div>
                          </form>
